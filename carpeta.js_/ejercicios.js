...
class ejercicios_js {
    ...
    numero_mayor_detres_numeros_Yserealiza_lasOperaciones(){
    ...
    sumatoria_num(){
        ...
        console.log("Ingrese la cantidad de números a sumar:");
    ...
    sumatoria_salarios(){
        ...
        while (contador <= 5) {
          console.log("Ingrese las horas trabajadas de la persona " + contador + ":");
          horas_trabajadas = parseInt(prompt("Ingrese las horas trabajadas de la persona " + contador + ":"));
        
          console.log("Ingrese la tarifa de pago de la persona " + contador + ":");
...
// ejer.numero_mayor_detres_numeros_Yserealiza_lasOperaciones()
// ejer. k_manzana();
